...
import { Settings, Key, Mail, Sparkles, MapPin, Search, Target, Globe, Zap, Save, AlertCircle, CheckCircle2 } from "lucide-react";
...
export default function SettingsPage({ onNav }: { onNav: (key: string) => void }) {
  ...
  if (loading) {
    return (
      <AppShell title="Settings" active="settings" onNav={onNav}>
    ...
    <AppShell title="Settings" active="settings" onNav={onNav}>
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">API Configuration</h2>
